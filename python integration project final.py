...
print("Hello,", name)
tos: str = input("Would you like a Sticker or a T-shirt?")
print("Product wanted is:", tos)
input_is_bad = True
while input_is_bad:
    try:
...
while input_is_bad:
    try:
        width: int = int(input('What is your desire width for image (in inches'
                               ')? Enter as an integer.'))
        input_is_bad = False
...
print("Your desired product is:", quantity, color, tos, "by", length, "x",
      width)
